...
namespace LibraryManagementSystem.UI.Book_Forms
{
    public partial class frmIssueBook : WeifenLuo.WinFormsUI.DockContent
    {
        ...
        private void FillGridBook(Books b)
        {
            ...
            dgvBookDetail.Rows.Add($"NoOfCopies    : {b.NoOfCopies}");
        }
        ...
        private void BtnSearchBook_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("The book belonging to this ID is out of stock.", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            ...
            {
                MessageBox.Show("No book found for this ID", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private void btnAddDgv_Click(object sender, EventArgs e)
        {
            if (btnSearchStudent.Enabled==false && btnSearchBook.Enabled == false)
            {
                if (FinesHelper.GetFineCount(Convert.ToInt32(txtStudentID.Text)) < 1)
                {
                    ...
                    {
                        MessageBox.Show("A Student Is Not Possible To Buy The Same Book More Than One.", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
                else
                {
                    MessageBox.Show("No Opportunity to Rent Books Since the Student Has More than One Unpaid Debt.", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            else
            {
