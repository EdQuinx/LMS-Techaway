...
namespace LibraryManagementSystem.UI.Report_Forms
{
    public partial class frmAllFines : WeifenLuo.WinFormsUI.DockContent
    {
        ...
        private void btnPay_Click(object sender, EventArgs e)
        {
            ...
            {
                ep.SetError(txtFinePay, "Fine cannot be left blank!");
                txtFinePay.Focus();
                return;
            }
            ...
            if (Convert.ToInt32(txtFinePay.Text) <= (f.FineAmount+f.RecivedAmount))
            {
                ...
                MessageBox.Show("Debt Update Successful.", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
                FillGridFines();
            }
            else
            {
                MessageBox.Show("The amount of debt we entered is greater than the remaining debt of the student belonging to this ID.", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
