...
namespace LibraryManagementSystem.UI
{
    public partial class frmDesignation : WeifenLuo.WinFormsUI.DockContent
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please Enter Designation!", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            MessageBox.Show("Add Designation successful", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
            FillGrid();
        }
    }
}
