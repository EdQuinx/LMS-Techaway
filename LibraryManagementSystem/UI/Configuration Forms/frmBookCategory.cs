...
namespace LibraryManagementSystem.UI.Configuration_Forms
{
    public partial class frmBookCategory : WeifenLuo.WinFormsUI.DockContent
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                ep.SetError(txtBookType, "Book type cannot be left blank!");
                txtBookType.Focus();
                return;
            }
            ...
            MessageBox.Show("Add Book Type Successful", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
