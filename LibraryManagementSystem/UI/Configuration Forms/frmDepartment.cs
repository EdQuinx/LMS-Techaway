...
namespace LibraryManagementSystem.UI.Configuration_Forms
{
    public partial class frmDepartment : WeifenLuo.WinFormsUI.DockContent
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please enter Department Name!", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            if (!DepartmentsHelper.HaveDepartmentName(txtDepartmentName.Text))
            {
                ...
                MessageBox.Show("Add department successful", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
                FillGrid();
            }
            else
            {
                MessageBox.Show("A Department with the same name is already added!", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                if (dgvDepartmentList.Rows.Count > 0)
                {
                    ...
                    {
                        DialogResult dialogResult = MessageBox.Show("Are you sure you want to delete Department?", "Library Management System", MessageBoxButtons.YesNo);
                        if (dialogResult == DialogResult.Yes)
                        {
                            ...
                            MessageBox.Show("Delete Department Successful", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        {
            epProgram.Clear();
            bool check = DepartmentsHelper.ControlValidate(txtDepartmentName, "Please Enter Department Name.", epProgram);
            ...
            if (check)
            {
                ...
                MessageBox.Show("Department update successful", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
                ClearForm();
                FillGrid();
                DisableComponent();
            }
