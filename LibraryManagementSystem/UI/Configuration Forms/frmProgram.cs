    ...
    public partial class frmProgram : WeifenLuo.WinFormsUI.DockContent
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (!ProgramsHelper.HaveProgramName(txtProgramName.Text))
            {
                ...
                MessageBox.Show("Add program successful", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
                FillGrid();
            }
            else
            {
                MessageBox.Show("A Program with the same name is already attached!", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                if (dgvProgramList.Rows.Count > 0)
                {
                    if (dgvProgramList.SelectedRows.Count == 1)
                    {
                        ...
                        if (dialogResult == DialogResult.Yes)
                        {
                            ...
                            MessageBox.Show("Program Delete Successful", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
                ...
                {
                    MessageBox.Show("Program list is empty!", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
            catch (Exception ex)
            {
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Program list is empty!", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        {
            epProgram.Clear();
            bool check = SessionsHelper.ControlValidate(txtProgramName, "Please Enter Program Name.", epProgram);
            ...
            if (check)
            {
                ...
                MessageBox.Show("Program update successful", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
                ClearForm();
                FillGrid();
                DisableComponent();
            }
